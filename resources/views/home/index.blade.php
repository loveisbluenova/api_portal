                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <form id="api-search" class="form-horizontal" action="/admin/searchable-api" method="GET">
                                ...
                                <div class="form-group"><label class="col-lg-3 control-label">Código unificado Holding Dimerc</label>

                                    <div class="col-lg-3"><input type="text" class="form-control searchable-input" name="codpro" value="{{$form_data[0]}}">
                                    </div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Código interno Dimerc</label>

                                    <div class="col-lg-3"><input type="text" class="form-control searchable-input" name="coduni"  value="{{$form_data[1]}}"></div>
                                </div>
                                <div class="form-group"><label class="col-lg-3 control-label">Código interno proveedor </label>

                                    <div class="col-lg-3"><input type="text" class="form-control searchable-input" name="codprv"  value="{{$form_data[3]}}"> 
                                    </div>
                                </div>
                    ...
                    @if($form_data[4] == 200)
                        {{ Form::open(['route' => 'admin.save_data', 'class' => 'form-horizontal', 'id' => 'data_input_field']) }}
                                ...
                                <div class="ibox-content">
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-10 control-label" style="padding-left: 0px; padding-right: 0px; ">Unidad de Medida Base (UMB)</label>
                                                ...
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">UMB/UMB</label>

                                                        <div class="col-lg-8"><input type="text" name="umb" id="umb" class="form-control" value="@if($product!=NULL){{$product->umb}}@endif">
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label"style="padding-left: 0px; padding-right: 0px; ">EAN 13</label>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-10 control-label" style="padding-left: 0px; padding-right: 0px; ">Maneja Inner Pack</label>
                                                ...
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">UMB/INNER PACK</label>

                                                        <div class="col-lg-8"><input type="text" class="form-control" name="umb_inner_pack" id="umb_inner_pack" value="@if($product!=NULL){{$product->umb_inner_pack}}@endif"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">DUN 14</label>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-10 control-label" style="padding-left: 0px; padding-right: 0px; ">Maneja Caja Master</label>
                                                ...
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">UMB/CAJA MASTER</label>

                                                        <div class="col-lg-8"><input type="text" class="form-control" name="umb_manage_box" id="umb_manage_box" value="@if($product!=NULL){{$product->umb_manage_box}}@endif"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">DUN 14</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">UMB/CAJA MASTER</label>
                                                        ...
                                                        <div class="col-lg-8"><input type="text" class="form-control" name="umb_layer" id="umb_layer" value="@if($product!=NULL) {{$product->umb_layer}} @endif"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">DUN 14</label>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">UMB/CAJA MASTER</label>
                                                        ...
                                                        <div class="col-lg-8"><input type="text" class="form-control" name="umb_pallet" id="umb_pallet" value="@if($product!=NULL) {{$product->umb_pallet}} @endif"></div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="form-group"><label class="col-lg-4 control-label" style="padding-left: 0px; padding-right: 0px; ">DUN 14</label>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group"><label class="col-lg-3 control-label">Unidad de Medida de Pedido (UMP)</label>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group"><label class="col-lg-3 control-label">Producto con Vencimiento</label>
                                        ...
                                        <div class="col-lg-1"><input type="checkbox" class="form-check-input" name="product_with_expiration" id="product_with_expiration" @if($product!=NULL && $product->product_with_expiration) checked @endif> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"><label class="col-lg-3 control-label">Exposicion al sol</label>
                                        ...
                                        <div class="col-lg-1"><input type="checkbox" class="form-check-input" name="sun_exposure" @if($product!=NULL && $product->sun_exposure) checked @endif> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group"><label class="col-lg-3 control-label">Humedad</label>
                                        ...
                                        <div class="col-lg-1"><input type="checkbox" class="form-check-input" name="humidity" @if($product!=NULL && $product->humidity) checked @endif> 
                                        </div>
                                    </div>
