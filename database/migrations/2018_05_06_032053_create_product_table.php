...
class CreateProductTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('product', function (Blueprint $table) {
            ...
            $table->decimal('net_weight_base_pro', 5, 3)->nullable()->default(0.000);
            $table->decimal('gross_weight_base_pro', 5, 3)->nullable()->default(0.000);
            ...
            $table->decimal('volume_base_pro', 10, 3)->nullable()->default(0.000);
            ...
            $table->decimal('net_weight_inner_pack', 5, 3)->nullable()->default(0.000);
            $table->decimal('gross_weight_inner_pack', 5, 3)->nullable()->default(0.000);
            ...
            $table->decimal('volume_inner_pack', 10, 3)->nullable()->default(0.000);
            ...
            $table->decimal('net_weight_manage_box', 5, 3)->nullable()->default(0.000);
            $table->decimal('gross_weight_manage_box', 5, 3)->nullable()->default(0.000);
            ...
            $table->decimal('volume_manage_box', 10, 3)->nullable()->default(0.000);
            $table->tinyInteger('handle_layer')->default(0)->unsigned();
            $table->Integer('umb_layer')->nullable();
            $table->Integer('dun_layer')->nullable();
            $table->decimal('net_weight_layer', 5, 3)->nullable()->default(0.000);
            $table->decimal('gross_weight_layer', 5, 3)->nullable()->default(0.000);
            ...
            $table->decimal('volume_layer', 10, 1)->nullable()->default(0.000);
            ...
            $table->decimal('net_weight_pallet', 5, 3)->nullable()->default(0.000);
            $table->decimal('gross_weight_pallet', 5, 3)->nullable()->default(0.000);
            ...
            $table->decimal('volume_pallet', 10, 1)->nullable()->default(0.000);
